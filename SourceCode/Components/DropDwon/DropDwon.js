            ...
            >
                <View style={[styles.button, shadowStyle, dropdownStyle,]}>
                    ...
                    <View style={[styles.iconContainerStyle, { backgroundColor: this.props.IconBackGroundColor }]}>
                        ...
                        {showArrow === false ?
                            <Image style={[styles.loginDropdownImages, arrowStyle, { tintColor: this.props.tintColor }]} source={images.avatar} />
                            : <Image style={[styles.loginDropdownImages, arrowStyle, { tintColor: this.props.tintColor }]} source={images.ic_down} />}
                    </View>
