...
class Button extends React.Component {
    ...
    renderIcon() {
        ...
        return (
            <Image source={icon} style={[styleIcon]} resizeMode={'contain'} />
    ...
    render() {
        ...
        let isIcon = icon !== undefined;
        let bgColor = this.props.bgColor || colors.gold;
        let height = this.props.height || Platform.OS === 'ios' ? hp(6) : hp(7);
        let width = this.props.width;


        return (
            <TouchableOpacity activeOpacity={this.props.activeOpacity} onPress={onPress !== undefined ? onPress : this.onPressDefault} style={[touchableStyle, { backgroundColor: bgColor, height: height, width: width }]}>
