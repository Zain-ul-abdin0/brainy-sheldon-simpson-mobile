...
class AppInput extends React.Component {
    ...
    render() {
        ...
        let leftImageHeight = this.props.leftImageHeight || 25;
        ...
        return (
            <View style={[styles.inputFieldTextView, shadow, style, {
                ...
                , borderColor: borderColor, borderRadius: borderRadius, borderBottomWidth: borderBottomWidth
            }]}>
                ...
                <TextInput
                    ...
                    style={[styles.inputFieldText, this.props.textInputStyle, { color: this.props.colortextInput || colors.black}, { fontSize: this.props.fontSize }]}
