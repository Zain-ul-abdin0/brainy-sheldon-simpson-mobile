            ...
            <View style={styles.mainContainer}>
                ...
                <View style={styles.conatiner}>
                    <View style={styles.addReview}>
                        <Text style={styles.addReviewStyle}>Create Profile</Text>
                    </View>
                    <View style={styles.snack}>
                        <Text style={styles.snackReviewStyle}>Create your profile to post and make reviews</Text>
                    </View>

                    <View style={styles.divider}></View>
                    <TouchableOpacity style={styles.postReviewStyle}>
                        <Text style={styles.textStylePost}>CREATE ACCOUNT</Text>
                    </TouchableOpacity>
                    <View style={styles.divider}></View>
                    <TouchableOpacity style={styles.postReviewStyle}>
                        <Text style={styles.textStyleClose}>I'LL DO IT LATER</Text>
                    </TouchableOpacity>
