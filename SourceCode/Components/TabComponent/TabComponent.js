...
export default class TabComponent extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            middleBorderWidth: 0,
            rightBorderWidth: 0,
            leftTextColor: colors.appGreenColor,
            middleTextColor: '#999999',
            rightTextColor: '#999999',
            leftBottomColor: colors.appGreenColor,
    ...
    onLeftPress = () => {
        if (this.state.leftTextColor === '#999999') {
            this.setState({ leftTextColor: colors.appGreenColor, middleTextColor: '#999999', rightTextColor: '#999999', leftBorderWidth: 2.5, middleBorderWidth: 0, rightBorderWidth: 0, leftBottomColor: colors.appGreenColor, middleBottomColor: colors.white, rightBottomColor: colors.white })
        }
    ...
    onRightPress = () => {
        if (this.state.rightTextColor === '#999999') {
            this.setState({ leftTextColor: '#999999', middleTextColor: '#999999', rightTextColor: colors.appGreenColor, leftBorderWidth: 0, middleBorderWidth: 0, rightBorderWidth: 2.5, leftBottomColor: colors.white, middleBottomColor: colors.white, rightBottomColor: colors.appGreenColor })
        }
